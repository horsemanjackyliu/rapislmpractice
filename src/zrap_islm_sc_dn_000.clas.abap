...
CLASS zrap_islm_sc_dn_000 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      tyt_a_outb_delivery_header_typ TYPE STANDARD TABLE OF tys_a_outb_delivery_header_typ WITH DEFAULT KEY.
...
CLASS ZRAP_ISLM_SC_DN_000 IMPLEMENTATION.
